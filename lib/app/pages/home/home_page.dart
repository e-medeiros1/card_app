      ...
      body: GetX<CardController>(
        ...
        builder: (controller) => Column(
          ...
          children: [
            ...
            GestureDetector(
              onTap: () {
                controller.launchWhatsapp(controller.toWhatsapp);
              },
              child: Containers(
                  text: 'Whatsapp',
                  icon: const Icon(
            ...
            GestureDetector(
              onTap: () {
                controller.launchInMail(controller.toEmail);
              },
              child: Containers(
                  text: 'Gmail',
                  icon: const Icon(
            ...
            GestureDetector(
              ...
              onTap: () {
                controller.launchInWeb(controller.toGithub);
              },
            ),
            const SizedBox(height: 20),
            //Linkedin
            GestureDetector(
              onTap: () {
                controller.launchInWeb(controller.toLinkedin);
              },
              child: Containers.image(
                text: 'Linkedin',
                image: const Image(
